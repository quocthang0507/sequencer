...
def _parse_args(model: str):
    ...
    args.batch_size = 16  # Batch size for training, default = 128
    ...
    args.weight_decay = 1e-1  # Weight decay
    ...
    args.warmup_epochs = 5  # Number of warmup epochs
    ...
    args.clip_grad = 1  # Clip gradient norm (default: None)
...
def main():
    ...
    for model_name in models:
        args, args_text = _parse_args(model_name)
